...
public class OrderDetailsModel : PageModel
{
    ...
    public async Task<IActionResult> OnPostUpdateStatusAsync(int subOrderId, string action)
    {
        ...
        {
            "preparing" => await _orderStatusService.UpdateSubOrderToPreparingAsync(subOrderId),
            "shipped" => await _orderStatusService.UpdateSubOrderToShippedAsync(
                subOrderId, TrackingNumber, CarrierName, TrackingUrl),
            "delivered" => await _orderStatusService.UpdateSubOrderToDeliveredAsync(subOrderId),
            "cancel" => await _orderStatusService.CancelSubOrderAsync(subOrderId),
