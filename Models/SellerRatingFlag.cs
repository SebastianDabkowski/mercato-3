...
/// <summary>
/// Represents a flag raised on a seller rating for moderation.
/// </summary>
public class SellerRatingFlag
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the seller rating ID being flagged.
    /// </summary>
    public int SellerRatingId { get; set; }

    /// <summary>
    /// Gets or sets the seller rating being flagged (navigation property).
    /// </summary>
